...
const Navbar = () => {
	...
	return (
		...
		>
			<Link className="w-[25%] md:w-[15%] h-full overflow-hidden" to="/">
				<img
			...
			<nav className="w-[40%] flex md:pl-3" aria-label="Breadcrumb">
			...
			<ul className="hidden w-[45%] md:flex md:justify-center">
